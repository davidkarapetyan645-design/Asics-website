      ...
      {isOpen ? (
        <>
          ...
          <div className="fixed inset-0 z-[70] sm:hidden">
            <motion.div
              className="modal-scroll flex h-[100dvh] w-full flex-col overflow-y-auto bg-[#fbfaf6] text-[#111318]"
              initial={{ opacity: 0, y: 18 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 12 }}
              transition={{ duration: 0.24, ease: [0.2, 0.9, 0.2, 1] }}
            >
              <div className="sticky top-0 z-10 border-b border-[#e6e0d4] bg-[#fbfaf6]/96 px-4 pb-4 pt-[max(1rem,env(safe-area-inset-top))] backdrop-blur-sm">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      className="rounded-full border border-[#dad3c6] px-4 py-2 text-sm font-medium text-[#24272d]"
              ...
              <div className="flex-1 px-4 py-4">
                {success ? (
                  <div className="rounded-[24px] border border-[#d8d1c4] bg-white px-6 py-10 text-center">
                    <p className="font-display text-[1.8rem] font-semibold tracking-display text-[#12151a]">
                      Payment complete
                    </p>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-[24px] border border-[#ddd7ca] bg-white p-4">
                      <p className="text-[11px] uppercase tracking-[0.22em] text-[#6f756d]">
                        Card type
                      </p>
                          ...
                          <button
                            ...
                            className={`rounded-full border px-4 py-2 text-sm font-medium ${
                              brand === item
                                ...
                                : "border-[#dad3c6] bg-white text-[#24272d]"
                            }`}
                      ...
                      <div className="grid gap-4">
                        <label className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full rounded-[18px] border border-[#d8d1c4] bg-white px-4 py-3 text-sm text-[#12151a] outline-none"
                    ...
                    <div className="rounded-[24px] border border-[#ddd7ca] bg-[#f5f2ea] p-4">
                      <p className="text-[11px] uppercase tracking-[0.22em] text-[#6f756d]">
                        Order summary
                      </p>
                      <div className="mt-4 space-y-3">
                        {items.map((item) => (
                          <div
                            key={item.id}
                            className="rounded-[20px] border border-[#ddd7ca] bg-white p-4"
                          >
                      ...
                      <div className="mt-4 rounded-[20px] border border-[#ddd7ca] bg-white p-4">
                        ...
                        <div className="mt-4 flex items-center justify-between font-display text-[1.3rem] font-semibold tracking-display text-[#14171c]">
                          <span>Total</span>
                          <span>${total}</span>
                        </div>
                      </div>
              ...
              {!success ? (
                <div className="sticky bottom-0 border-t border-[#e6e0d4] bg-[#fbfaf6]/96 px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-4 backdrop-blur-sm">
                  <button
                    className="w-full rounded-full bg-[#16191f] px-5 py-4 text-sm font-semibold uppercase tracking-[0.18em] text-white disabled:cursor-not-allowed disabled:opacity-50"
                    disabled={!isReady}
                    onClick={handlePay}
                    type="button"
                  >
          ...
          <motion.div
            className="fixed inset-0 z-[70] hidden items-end justify-center p-0 sm:flex sm:p-6"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            <motion.div
              className="modal-scroll max-h-[calc(100dvh-3rem)] w-full max-w-[760px] overflow-y-auto rounded-[34px] border border-[#ddd7ca] bg-[#fbfaf6] text-[#111318] shadow-[0_30px_120px_rgba(15,17,21,0.22)]"
