    ...
    <AnimatePresence>
      {isOpen ? (
        <>
          ...
          <div className="fixed inset-0 z-[90] sm:hidden">
            ...
            >
              ...
              <div className="flex-1 px-4 py-4">
                <div className="rounded-[24px] border border-[#e5dfd2] bg-white">
                  <div className="grid grid-cols-4 border-b border-[#ece5d8] bg-[#f7f4ed] px-3 py-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#6e756d]">
                    <span>EU</span>
                    <span>US M</span>
                    <span>US W</span>
                    <span>CM</span>
                  ...
                  <div className="divide-y divide-[#efe8dc]">
                    {sizeGuideRows.map((row) => (
                      <div key={row.eu} className="grid grid-cols-4 px-3 py-3 text-sm text-[#171b22]">
          ...
          <motion.div
            className="fixed inset-0 z-[90] hidden items-end justify-center p-0 sm:flex sm:p-6"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            <motion.div
              className="modal-scroll max-h-[calc(100dvh-3rem)] w-full max-w-[860px] overflow-y-auto rounded-[34px] border border-[#ddd7ca] bg-[#fbfaf6] text-[#111318] shadow-[0_30px_120px_rgba(15,17,21,0.22)]"
              initial={{ opacity: 0, y: 24, scale: 0.98 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              exit={{ opacity: 0, y: 20, scale: 0.98 }}
              transition={{ duration: 0.28, ease: [0.2, 0.9, 0.2, 1] }}
            >
              <div className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-3 border-b border-[#e6e0d4] bg-[#fbfaf6]/96 px-5 py-5 backdrop-blur-sm sm:px-6">
                <div>
                  <p className="text-[11px] uppercase tracking-[0.22em] text-[#6f756d]">
                    Size guide
                  </p>
